...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-layout','data' => ['title' => 'Savings Certificates (Shonchoy Potro)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Savings Certificates (Shonchoy Potro)']); ?>
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div>
            <a href="<?php echo e(route('bank-asia.shonchoy-potros.create')); ?>" class="btn btn-primary inline-flex items-center gap-2">
    ...
    <form action="<?php echo e(route('bank-asia.shonchoy-potros.index')); ?>" method="GET" class="surface p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-4 items-end">
            <div class="flex-1 w-full">
                ...
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search by purchaser name, NID, phone or certificate/registration no..." class="field">
            </div>
            ...
            <div class="w-full md:w-40">
                ...
                <select name="status" class="field">
                    ...
                    <option value="encashed" <?php echo e(request('status') === 'encashed' ? 'selected' : ''); ?>>Encashed</option>
                </select>
            </div>
            <div class="flex gap-2 w-full md:w-auto">
                <button type="submit" class="btn btn-primary w-full md:w-auto px-5">Filter</button>
                <a href="<?php echo e(route('bank-asia.shonchoy-potros.index')); ?>" class="btn btn-muted w-full md:w-auto px-4 text-center">Reset</a>
            </div>
        </div>
    </form>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                    <?php $__empty_1 = true; $__currentLoopData = $certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                            <td class="p-4">
                                <div class="font-bold text-slate-900 dark:text-white"><?php echo e($cp->purchaser_name); ?></div>
                                <div class="text-xs text-slate-500 dark:text-slate-400 mt-0.5"><?php echo e($cp->purchaser_phone); ?></div>
                            </td>
                            <td class="p-4 font-semibold text-slate-700 dark:text-slate-300">
                                <?php echo e($cp->certificate_type_label); ?>

                            </td>
                            <td class="p-4 font-mono text-xs">
                                <div>Cert: <?php echo e($cp->certificate_number); ?></div>
                                <div class="text-slate-500 dark:text-slate-400 mt-0.5">Reg: <?php echo e($cp->registration_number); ?></div>
                            </td>
                            <td class="p-4 whitespace-nowrap">
                                <div>Pur: <?php echo e($cp->purchase_date->format('Y-m-d')); ?></div>
                                <div class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Mat: <?php echo e($cp->maturity_date->format('Y-m-d')); ?></div>
                            </td>
                            <td class="p-4 text-right font-bold text-slate-900 dark:text-white">
                                ৳ <?php echo e(number_format($cp->purchase_amount, 2)); ?>

                                <?php if($cp->interest_rate): ?>
                                    <div class="text-[10px] font-normal text-slate-500 dark:text-slate-400 mt-0.5">Rate: <?php echo e($cp->interest_rate); ?>%</div>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="p-4 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('bank-asia.shonchoy-potros.show', $cp)); ?>" class="btn btn-muted py-1.5 px-3 text-xs flex items-center gap-1">
                                    ...
                                    <a href="<?php echo e(route('bank-asia.shonchoy-potros.edit', $cp)); ?>" class="btn btn-muted py-1.5 px-3 text-xs flex items-center gap-1">
                                    ...
                                    <form action="<?php echo e(route('bank-asia.shonchoy-potros.destroy', $cp)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');" class="inline">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/sahil/development/office_project/dpoerp/resources/views/services/bank-asia/shonchoy-potros/index.blade.php ENDPATH**/ ?>