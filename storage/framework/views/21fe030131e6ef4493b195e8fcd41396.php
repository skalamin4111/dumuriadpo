...
<?php $component->withAttributes(['title' => 'TP Update Print']); ?>
    ...
    <div class="mb-6 flex items-center justify-between no-print" x-data="tpDocumentUpload(<?php echo e($expectedPages); ?>)">
        <a href="<?php echo e(route('bank-asia.tp-updates.index')); ?>" class="btn btn-muted">
