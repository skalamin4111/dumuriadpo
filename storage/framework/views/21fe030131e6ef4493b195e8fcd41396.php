    ...
    <div x-data="tpDocumentUpload(<?php echo e($expectedPages); ?>)">
        <div class="mb-6 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4 no-print">
            <div class="flex flex-wrap items-center gap-3 w-full xl:w-auto">
                <a href="<?php echo e(route('bank-asia.tp-updates.index')); ?>" class="btn btn-muted flex items-center gap-2 shrink-0">
            ...
            <div class="flex flex-wrap items-center gap-2 sm:gap-3 w-full xl:w-auto">
                <a href="<?php echo e(route('bank-asia.tp-updates.edit', $tpUpdate)); ?>" class="btn btn-muted flex items-center gap-2 shrink-0">
