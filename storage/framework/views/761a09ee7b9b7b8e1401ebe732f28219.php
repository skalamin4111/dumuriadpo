...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-layout','data' => ['title' => 'আয়ের উৎস ঘোষণা-পত্র - New Declaration']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'আয়ের উৎস ঘোষণা-পত্র - New Declaration']); ?>
    <div class="mb-6">
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('bank-asia.ac-creations.index')); ?>" class="btn btn-muted px-2.5">
    ...
    <form action="<?php echo e(route('bank-asia.ac-creations.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <section class="surface p-6">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div>
                    ...
                    <div class="flex gap-4 mt-2">
                        <label class="inline-flex items-center">
                            <input type="radio" name="account_type" value="new" <?php echo e(old('account_type', 'new') === 'new' ? 'checked' : ''); ?> class="text-primary-600 focus:ring-primary-500">
                            <span class="ml-2 text-sm text-slate-700 dark:text-slate-300">নতুন (New)</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="account_type" value="dormant" <?php echo e(old('account_type') === 'dormant' ? 'checked' : ''); ?> class="text-primary-600 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" name="account_number" class="field" placeholder="হিসাব নং (যদি থাকে)" value="<?php echo e(old('account_number')); ?>">
                </div>
            </div>
        </section>
        ...
        <section class="surface p-6">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                <div>
                    ...
                    <input type="text" name="applicant_name_bn" class="field" placeholder="গ্রাহকের সম্পূর্ণ নাম" value="<?php echo e(old('applicant_name_bn')); ?>" required>
                </div>
                <div>
                    ...
                    <input type="text" name="father_name" class="field" placeholder="পিতা অথবা স্বামীর নাম" value="<?php echo e(old('father_name')); ?>" required>
                </div>
                <div>
                    ...
                    <input type="text" name="mother_name" class="field" placeholder="মাতার নাম" value="<?php echo e(old('mother_name')); ?>" required>
                </div>
                <div>
                    ...
                    <input type="text" name="nid_number" class="field" placeholder="NID / Passport / Birth Reg" value="<?php echo e(old('nid_number')); ?>" required>
                </div>
                <div>
                    ...
                    <input type="text" name="mobile_number" class="field" placeholder="মোবাইল নম্বর" value="<?php echo e(old('mobile_number')); ?>" required>
                </div>
                <div>
                    <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">কাস্টমার আইডি (Customer ID - optional)</label>
                    <input type="text" name="customer_id" class="field" placeholder="কাস্টমার আইডি" value="<?php echo e(old('customer_id')); ?>">
                </div>
            </div>
            <div class="grid gap-5 sm:grid-cols-1 mt-4">
                <div>
                    ...
                    <textarea name="present_address" rows="2" class="field" placeholder="গ্রাম, ডাকঘর, উপজেলা, জেলা" required><?php echo e(old('present_address')); ?></textarea>
                </div>
            </div>
        </section>
        ...
        <section class="surface p-6">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                <div>
                    ...
                    <input type="text" name="occupation" class="field" placeholder="যেমন: ব্যবসা, গৃহিণী, কৃষি" value="<?php echo e(old('occupation')); ?>" required>
                </div>
                <div>
                    ...
                    <input type="text" name="source_of_funds" class="field" placeholder="যেমন: কৃষি কাজ, দোকানের আয়, প্রবাসী অর্থ" value="<?php echo e(old('source_of_funds')); ?>" required>
                </div>
                <div>
                    ...
                    <input type="text" step="১০০০" name="monthly_income" class="field" placeholder="টাকা" value="<?php echo e(old('monthly_income')); ?>" required>
                </div>
            </div>
        </section>
        ...
        <section class="surface p-6">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div>
                    ...
                    <input type="text" name="outlet_name_address" class="field" value="<?php echo e(old('outlet_name_address', 'ডুমুরিয়া ডি পি ও, খুলনা')); ?>" required>
                </div>
                <div>
            ...
            <div class="grid gap-5 sm:grid-cols-2 mt-4">
                <div>
                    ...
                    <select name="status" class="field" required>
                        <option value="pending" <?php echo e(old('status') === 'pending' ? 'selected' : ''); ?>>Pending (পেন্ডিং)</option>
                        <option value="submitted" <?php echo e(old('status') === 'submitted' ? 'selected' : ''); ?>>Submitted (দাখিলকৃত)</option>
                        <option value="approved" <?php echo e(old('status') === 'approved' ? 'selected' : ''); ?>>Approved (অনুমোদিত)</option>
                        <option value="rejected" <?php echo e(old('status') === 'rejected' ? 'selected' : ''); ?>>Rejected (প্রত্যাখ্যাত)</option>
                    </select>
                </div>
        ...
        <div class="flex gap-4 justify-end">
            <a href="<?php echo e(route('bank-asia.ac-creations.index')); ?>" class="btn btn-muted px-6">Cancel</a>
...
<?php endif; ?>
<?php /**PATH /home/sahil/development/office_project/dpoerp/resources/views/services/bank-asia/ac-creations/create.blade.php ENDPATH**/ ?>