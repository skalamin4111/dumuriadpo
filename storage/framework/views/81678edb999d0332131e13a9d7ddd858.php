                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                    <?php $__empty_1 = true; $__currentLoopData = $tpUpdates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $update): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="transition hover:bg-slate-50 dark:hover:bg-slate-800">
                            <td class="whitespace-nowrap px-4 py-3"><?php echo e($update->date); ?></td>
                            <td class="whitespace-nowrap px-4 py-3 font-medium"><?php echo e($update->account_name); ?></td>
                            <td class="whitespace-nowrap px-4 py-3"><?php echo e($update->account_number); ?></td>
                                    ...
                                    <?php if(count($regularTypes) > 0): ?>
                                        <div>
                                            ...
                                            <?php if(count($regularFreqs) > 0): ?>
                                                <div class="mt-1 pl-1 text-[11px] font-medium text-slate-500 dark:text-slate-400"><?php echo e(implode(' & ', $regularFreqs)); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if(count($oneTimeTypes) > 0): ?>
                                        <div>
                                            ...
                                            <?php if(count($oneTimeFreqs) > 0): ?>
                                                <div class="mt-1 pl-1 text-[11px] font-medium text-slate-500 dark:text-slate-400"><?php echo e(implode(' & ', $oneTimeFreqs)); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <td class="whitespace-nowrap px-4 py-3 font-medium align-top">
                                <?php echo e($amount > 0 ? '৳ ' . number_format($amount) : '-'); ?>

                            </td>
                            <td class="whitespace-nowrap px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('bank-asia.tp-updates.show', $update)); ?>" class="btn btn-muted px-2 py-1.5" title="View / Print">
                                    ...
                                    <a href="<?php echo e(route('bank-asia.tp-updates.edit', $update)); ?>" class="btn btn-muted px-2 py-1.5" title="Edit">
                                    ...
                                    <form action="<?php echo e(route('bank-asia.tp-updates.destroy', $update)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this TP update?');" class="inline-block">
                                        <?php echo csrf_field(); ?>
