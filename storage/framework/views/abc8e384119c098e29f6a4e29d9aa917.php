...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.app-layout','data' => ['title' => 'Bank Asia Service Portal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Bank Asia Service Portal']); ?>
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <div class="mt-4 flex items-baseline gap-2">
                        <p class="text-4xl font-black tracking-tight text-slate-900 dark:text-white"><?php echo e($stats['total_accounts']); ?></p>
                        <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-blue-50 text-blue-700 dark:bg-blue-950/70 dark:text-blue-300">
                            <?php echo e($stats['pending_accounts']); ?> Pending
                        </span>
                    </div>
                </div>
        ...
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm dark:border-slate-800/80 dark:bg-slate-900/80 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <div class="mt-4 flex items-baseline gap-2">
                        <p class="text-4xl font-black tracking-tight text-slate-900 dark:text-white"><?php echo e($stats['total_tp_updates']); ?></p>
                    </div>
                </div>
        ...
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm dark:border-slate-800/80 dark:bg-slate-900/80 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <div class="mt-4 flex items-baseline gap-2">
                        <p class="text-4xl font-black tracking-tight text-slate-900 dark:text-white"><?php echo e($stats['active_certificates']); ?></p>
                    </div>
                </div>
        ...
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white p-6 shadow-sm dark:border-slate-800/80 dark:bg-slate-900/80 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <div class="mt-4 flex items-baseline gap-2">
                        <p class="text-2xl font-black tracking-tight text-slate-900 dark:text-white">৳ <?php echo e(number_format($stats['total_investment'])); ?></p>
                    </div>
                </div>
        ...
        <div class="grid gap-6 sm:grid-cols-3">
            ...
            <div class="surface p-6 flex flex-col justify-between h-48 border border-slate-200 hover:border-teal-500 dark:border-slate-800 dark:hover:border-teal-400 transition-all duration-300 rounded-2xl group shadow-sm hover:shadow-md">
                ...
                <div class="flex items-center justify-between mt-4">
                    <a href="<?php echo e(route('bank-asia.ac-creations.create')); ?>" class="text-xs text-teal-600 dark:text-teal-400 font-semibold flex items-center gap-1 hover:underline">
                        + New Account
                    </a>
                    <a href="<?php echo e(route('bank-asia.ac-creations.index')); ?>" class="btn btn-muted py-1.5 px-3 text-xs">
                        Manage
                    </a>
                </div>
            </div>
            ...
            <div class="surface p-6 flex flex-col justify-between h-48 border border-slate-200 hover:border-teal-500 dark:border-slate-800 dark:hover:border-teal-400 transition-all duration-300 rounded-2xl group shadow-sm hover:shadow-md">
                ...
                <div class="flex items-center justify-between mt-4">
                    <a href="<?php echo e(route('bank-asia.tp-updates.create')); ?>" class="text-xs text-teal-600 dark:text-teal-400 font-semibold flex items-center gap-1 hover:underline">
                        + New TP Update
                    </a>
                    <a href="<?php echo e(route('bank-asia.tp-updates.index')); ?>" class="btn btn-muted py-1.5 px-3 text-xs">
                        Manage
                    </a>
                </div>
            </div>
            ...
            <div class="surface p-6 flex flex-col justify-between h-48 border border-slate-200 hover:border-teal-500 dark:border-slate-800 dark:hover:border-teal-400 transition-all duration-300 rounded-2xl group shadow-sm hover:shadow-md">
                ...
                <div class="flex items-center justify-between mt-4">
                    <a href="<?php echo e(route('bank-asia.shonchoy-potros.create')); ?>" class="text-xs text-teal-600 dark:text-teal-400 font-semibold flex items-center gap-1 hover:underline">
                        + Register Certificate
                    </a>
                    <a href="<?php echo e(route('bank-asia.shonchoy-potros.index')); ?>" class="btn btn-muted py-1.5 px-3 text-xs">
                        Manage
                    </a>
                </div>
            </div>
        ...
        <div class="surface p-6 rounded-2xl border border-slate-200/60 dark:border-slate-800/80 shadow-sm flex flex-col justify-between">
            <div>
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('bank-asia.ac-creations.index')); ?>" class="text-xs font-semibold text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300">
                        View all
                    </a>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            <?php $__empty_1 = true; $__currentLoopData = $recentAcCreations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-2.5"><?php echo e($ac->date->format('Y-m-d')); ?></td>
                                    <td class="py-2.5 font-semibold text-slate-800 dark:text-slate-200"><?php echo e($ac->applicant_name_en); ?></td>
                                    <td class="py-2.5"><?php echo e($ac->mobile_number); ?></td>
                                    <td class="py-2.5">
        ...
        <div class="surface p-6 rounded-2xl border border-slate-200/60 dark:border-slate-800/80 shadow-sm flex flex-col justify-between">
            <div>
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('bank-asia.shonchoy-potros.index')); ?>" class="text-xs font-semibold text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300">
                        View all
                    </a>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            <?php $__empty_1 = true; $__currentLoopData = $recentCertificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="py-2.5 font-semibold text-slate-800 dark:text-slate-200"><?php echo e($cp->certificate_type_label); ?></td>
                                    <td class="py-2.5"><?php echo e($cp->purchaser_name); ?></td>
                                    <td class="py-2.5 font-semibold">৳ <?php echo e(number_format($cp->purchase_amount)); ?></td>
                                    <td class="py-2.5">
                                        <span class="inline-flex items-center rounded-md px-2 py-0.5 font-bold uppercase text-[9px]
                                            <?php if($cp->status === 'active'): ?> bg-emerald-50 text-emerald-700 dark:bg-emerald-950/70 dark:text-emerald-300
                                            <?php elseif($cp->status === 'matured'): ?> bg-blue-50 text-blue-700 dark:bg-blue-950/70 dark:text-blue-300
                                            <?php else: ?> bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 <?php endif; ?>">
                                            <?php echo e($cp->status); ?>
...
<?php endif; ?>
<?php /**PATH /home/sahil/development/office_project/dpoerp/resources/views/services/bank-asia/index.blade.php ENDPATH**/ ?>