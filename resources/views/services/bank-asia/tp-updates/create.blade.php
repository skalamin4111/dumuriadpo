<x-app-layout title="New TP Update">
    <div class="mb-6">
    ...
    <form action="{{ route('bank-asia.tp-updates.store') }}" method="POST" class="space-y-6 lg:space-y-8"
        x-data="{
            regDepositAmt: '{{ old('regular_daily_tx_amount', '') }}',
            oneTimeDepositAmt: '{{ old('one_time_cash_deposit_amount', '') }}',
            undertakingOpen: {{ old('animal_quantity') || old('total_amount') ? 'true' : 'false' }},
            undertakingAmount: '{{ old('total_amount', '') }}',
    ...
    >
        ...
        <section class="surface p-6 mb-6">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <input type="text" name="account_number" class="field" value="{{ old('account_number') }}" required>
                </div>
                <div>
                    ...
                    <input type="text" name="account_name" class="field" value="{{ old('account_name') }}" required>
                </div>
                <div>
                    ...
                    <select name="account_type" class="field" required>
                        <option value="Savings Account" {{ old('account_type') == 'Savings Account' ? 'selected' : '' }}>Savings Account (সেভিংস একাউন্ট)</option>
                        <option value="Current Account" {{ old('account_type') == 'Current Account' ? 'selected' : '' }}>Current Account (কারেন্ট একাউন্ট)</option>
                        <option value="SND Account" {{ old('account_type') == 'SND Account' ? 'selected' : '' }}>SND Account (এস.এন.ডি একাউন্ট)</option>
                        <option value="Other" {{ old('account_type') == 'Other' ? 'selected' : '' }}>Other (অন্যান্য)</option>
                    </select>
                </div>
                <div>
                    <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Client Mobile</label>
                    <input type="text" name="client_mobile" class="field" value="{{ old('client_mobile') }}">
                </div>
            </div>
        </section>
            ...
            <div x-show="isOpen" style="display: none;" class="space-y-6 mt-6">
                ...
                <div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <input type="number" name="regular_daily_tx_count" class="field" value="{{ old('regular_daily_tx_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Amount</label>
                            <input type="number" step="1" name="regular_daily_tx_amount" class="field" value="{{ old('regular_daily_tx_amount') }}" x-model="regDepositAmt">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Tx Count</label>
                            <input type="number" name="regular_monthly_tx_count" class="field" value="{{ old('regular_monthly_tx_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Amount</label>
                            <input type="number" step="1" name="regular_monthly_tx_amount" class="field" value="{{ old('regular_monthly_tx_amount') }}">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Tx Count</label>
                            <input type="number" name="regular_withdrawal_daily_count" class="field" value="{{ old('regular_withdrawal_daily_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Amount</label>
                            <input type="number" step="1" name="regular_withdrawal_daily_amount" class="field" value="{{ old('regular_withdrawal_daily_amount') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Tx Count</label>
                            <input type="number" name="regular_withdrawal_monthly_count" class="field" value="{{ old('regular_withdrawal_monthly_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Amount</label>
                            <input type="number" step="1" name="regular_withdrawal_monthly_amount" class="field" value="{{ old('regular_withdrawal_monthly_amount') }}">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Tx Count</label>
                            <input type="number" name="regular_transfer_daily_count" class="field" value="{{ old('regular_transfer_daily_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Amount</label>
                            <input type="number" step="1" name="regular_transfer_daily_amount" class="field" value="{{ old('regular_transfer_daily_amount') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Tx Count</label>
                            <input type="number" name="regular_transfer_monthly_count" class="field" value="{{ old('regular_transfer_monthly_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Amount</label>
                            <input type="number" step="1" name="regular_transfer_monthly_amount" class="field" value="{{ old('regular_transfer_monthly_amount') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="surface p-6 mb-6" x-data="{ isOpen: {{ (old('one_time_cash_deposit_count') || old('one_time_cash_deposit_amount') || old('one_time_cash_deposit_monthly_count') || old('one_time_cash_deposit_monthly_amount') || old('one_time_cash_withdrawal_count') || old('one_time_cash_withdrawal_amount') || old('one_time_cash_withdrawal_monthly_count') || old('one_time_cash_withdrawal_monthly_amount') || old('one_time_transfer_count') || old('one_time_transfer_amount') || old('one_time_transfer_monthly_count') || old('one_time_transfer_monthly_amount') || old('source_of_funds')) ? 'true' : 'false' }} }">
            ...
            <div x-show="isOpen" style="display: none;" class="space-y-6 mt-6">
                ...
                <div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Tx Count</label>
                            <input type="number" name="one_time_cash_deposit_count" class="field" value="{{ old('one_time_cash_deposit_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Amount</label>
                            <input type="number" step="1" name="one_time_cash_deposit_amount" class="field" value="{{ old('one_time_cash_deposit_amount') }}" x-model="oneTimeDepositAmt">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Tx Count</label>
                            <input type="number" name="one_time_cash_deposit_monthly_count" class="field" value="{{ old('one_time_cash_deposit_monthly_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Amount</label>
                            <input type="number" step="1" name="one_time_cash_deposit_monthly_amount" class="field" value="{{ old('one_time_cash_deposit_monthly_amount') }}">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Tx Count</label>
                            <input type="number" name="one_time_cash_withdrawal_count" class="field" value="{{ old('one_time_cash_withdrawal_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Amount</label>
                            <input type="number" step="1" name="one_time_cash_withdrawal_amount" class="field" value="{{ old('one_time_cash_withdrawal_amount') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Tx Count</label>
                            <input type="number" name="one_time_cash_withdrawal_monthly_count" class="field" value="{{ old('one_time_cash_withdrawal_monthly_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Amount</label>
                            <input type="number" step="1" name="one_time_cash_withdrawal_monthly_amount" class="field" value="{{ old('one_time_cash_withdrawal_monthly_amount') }}">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Tx Count</label>
                            <input type="number" name="one_time_transfer_count" class="field" value="{{ old('one_time_transfer_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Daily Amount</label>
                            <input type="number" step="1" name="one_time_transfer_amount" class="field" value="{{ old('one_time_transfer_amount') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Tx Count</label>
                            <input type="number" name="one_time_transfer_monthly_count" class="field" value="{{ old('one_time_transfer_monthly_count') }}">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-slate-700 dark:text-slate-300">Monthly Amount</label>
                            <input type="number" step="1" name="one_time_transfer_monthly_amount" class="field" value="{{ old('one_time_transfer_monthly_amount') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div x-show="isOpen" style="display: none;" class="mt-5 border-t pt-5">
                ...
                <input type="text" name="source_of_funds" class="field" value="{{ old('source_of_funds') }}">
            </div>
        </section>
            ...
            <div x-show="undertakingOpen" style="display: none;" class="mt-6">
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="animal_quantity" class="field" value="{{ old('animal_quantity') }}">
                    </div>
                    <div>
        ...
        <section class="surface p-6 mb-6">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <input type="text" name="outlet_name_address" class="field" value="{{ old('outlet_name_address', 'ডুমুরিয়া ডি পি ও, খুলনা') }}">
                </div>
            </div>
        </section>
