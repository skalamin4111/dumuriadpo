...
<div class="flex flex-col gap-4 sm:flex-row sm:items-center justify-between p-4 border-b border-slate-200 dark:border-slate-800">
            ...
            advanceAbsenceDate: '{{ now()->addDay()->toDateString() }}',
            advanceAbsenceNotes: '',
            ...
            openAdvanceAbsence(student) {
                ...
                this.advanceAbsenceDate = '{{ now()->addDay()->toDateString() }}';
            ...
            <template x-teleport="body">
                <div x-show="showBulkModal" 
                    ...
                    <div class="w-full max-w-4xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 relative flex flex-col max-h-[90vh]" @click.self="showBulkModal = false">
                        ...
                        <form method="POST" action="{{ route('computer-training.attendance.bulk') }}" @submit="handleBulkSubmit($event)" class="flex flex-col overflow-hidden h-full">
                            @csrf
            ...
            <template x-teleport="body">
                <div x-show="advanceAbsenceStudent !== null" 
                    ...
                    <div class="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 relative flex flex-col" @click.self="advanceAbsenceStudent = null">
                        <form method="POST" action="{{ route('computer-training.advance-absence.store') }}" class="flex flex-col">
                            @csrf
                ...
                @forelse ($attendanceRecords as $attendance)
                    <article class="surface p-4 hover:shadow-md transition-shadow relative overflow-hidden flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer"
                             @click="viewStudentAttendance = {
                                 ...
                                 is_advance_absence: {{ $attendance->is_advance_absence ? 'true' : 'false' }},
                                 student: {
                        ...
                        <div class="flex items-center gap-4 flex-1">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                @endif
                                @if($attendance->is_advance_absence)
                                    <div class="mt-2 flex">
